...
// const WhyUs = () =>{
//   return (
//     <div className="w-full bg-page-bg py-4 pt-0 px-6 flex flex-col items-center">
//       <div className="max-w-4xl text-center mb-16"> 
//       <p className="text-sm text-sky-400 font-bold py-8 px-2">[ <span  className="text-sm text-white font-medium">Our Core Advantages</span> ]</p>
...
// const WhyUs = () => {
//   return (
//     <div className="w-full bg-page-bg py-6 px-4 sm:px-6 md:px-10 flex flex-col items-center">
//       {/* Heading Section */}
//       <div className="max-w-5xl text-center mb-12">
//         <p className="text-sm sm:text-sm text-sky-400 font-bold py-4 px-2">
